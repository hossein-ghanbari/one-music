            ...
            return (
              <div className={styles.col}>
                <Link
                  ...
                  style={{ backgroundColor: data, boxShadow: "0 7px 10px -4px" + data + "aa" }}
                  // onClick={() => alert(itemData.id)}
                  to={`/artists/${itemData.id}`}
                >
                  <div className={styles.coverContainer}>
                    <LazyLoad offset={-10} once>
                      <img src={itemData.cover} className={styles.cover} alt={itemData.name} />
                    </LazyLoad>
                    <span className={styles.wave} style={{ backgroundColor: data }} />
                  </div>
